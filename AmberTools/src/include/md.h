...
integer nrp,nspm,ig,ntx,ntcx,            &!5
      ...
      mask_from_ref,hidx, reservoir_exchange_step,isynctraj, iextpot !94
...
parameter (BC_MDI=94) ! Number of elements in the common block;
                      ! New2022 Updated. Be sure to update if you change things
