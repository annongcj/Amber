...
//soft force between pairs of particles not in the same chain. Half-max at half-R.
#define SF_MAX_R       5.5
#define SF_MAX_R2     (SF_MAX_R * SF_MAX_R)
#define SF_WELL_H      6.0 //AMBER units, kcal/mol not KbT
...
typedef enum{ HSC_POTENTIAL_NULL             = 0,
              ...
              HSC_POTENTIAL_SOFTSTEP_LIQUID  = 5,
              HSC_POTENTIAL_WOBBLIUM         = 6,
              HSC_POTENTIAL_RELATIVE_POS     = 7,
              HSC_POTENTIAL_NUMPOTS          = 8
} HSC_POTENTIAL_T;
#define HSC_POTENTIAL_NAME(x) (x==HSC_POTENTIAL_NULL?            "Null             ":\
                               ...
                               x==HSC_POTENTIAL_SOFTSTEP_LIQUID? "Softstep Liquid  ":\
...
class hsc {
 ...
 public:
  ...
  double epsilonBond, epsilonTriangle, epsilonSolid, epsilonTrap, wingForce; //coupling strength
