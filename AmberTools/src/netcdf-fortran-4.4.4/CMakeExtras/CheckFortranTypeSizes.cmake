# Amber: this file taken from https://github.com/ampl/lapack/blob/master/CMAKE/CheckFortranTypeSizes.cmake
...
# SIZEOF_DOUBLE_PRECISION - Number of bytes used to store the default DOUBLE PRECISION type
#=============================================================================
# Author: Chuck Atkins
# Copyright 2011
#=============================================================================
...
")
    ...
    if( SIZEOF_${_TYPE_NAME} )
	  ...
	  string(REPLACE " " "_" TYPE_NAME_WITHOUT_SPACES ${_TYPE_NAME})
      
      set( SIZEOF_${TYPE_NAME_WITHOUT_SPACES} ${__TEST_SIZE} CACHE INTERNAL "Size of the default ${_TYPE_NAME} type" FORCE )
      break()
    else()
      message( STATUS "Testing default ${_TYPE_NAME}*${__TEST_SIZE} - not found" )
    endif()
  endforeach()
...
macro( CHECK_FORTRAN_TYPE_SIZES )
  ...
  _CHECK_FORTRAN_TYPE_SIZE( "CHARACTER" "1;2;4;8" )
  _CHECK_FORTRAN_TYPE_SIZE( "DOUBLE PRECISION" "4;8;16" )
