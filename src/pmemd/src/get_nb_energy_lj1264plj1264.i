!*******************************************************************************
!
! Subroutine:  get_nb_energy_1264p1264 New2022
!
! Description:
!
! The main routine for non bond energy (vdw and hbond) as well as direct part
! of ewald sum.  It is structured for parallelism. This has been modified
! for pairwise 12-6-4 LJ-type nonbonded model.
!*******************************************************************************

subroutine get_nb_energy_1264p1264(img_frc, img_crd, img_qterm, eed_cub, &  ! New2022
      ...
      if (ee_eval_cnt + full_eval_cnt .gt. 0) then
        ...
        if (cutoffs_equal) then
          call pairs_calc_efv(img_frc, img_crd, img_qterm, efs_tbl, &
                              ...
                              gbl_img_iac, gbl_cn1, gbl_cn2, gbl_cn6, &
                              gbl_cn7, gbl_cn8, C4Pairwise, x_tran) ! New2022
        else
...
!1264 CODE: GET_NB_ENE_P1264
#define BUILD_PAIRS_1264P1264 ! New2022

#define BUILD_PAIRS_CALC_EFV
#define NEED_ENE
#define NEED_VIR
#include "pairs_calc_lj1264plj1264.i" ! New2022
#undef NEED_VIR
#undef NEED_ENE
...
end subroutine get_nb_energy_1264p1264 ! New2022
