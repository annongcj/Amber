...
! for 12-6-4 LJ-type nonbonded model.
!*******************************************************************************

subroutine get_nb_energy_1264(img_frc, img_crd, img_qterm, eed_cub, &
...
!1264 CODE: GET_NB_ENE_1264
#define BUILD_PAIRS_1264

#define BUILD_PAIRS_CALC_EFV
#define NEED_ENE
#define NEED_VIR
#include "pairs_calc_lj1264.i"
#undef NEED_VIR
#undef NEED_ENE
...
end subroutine get_nb_energy_1264
