!*******************************************************************************
!
! Subroutine:  get_nb_energy_p1264
!
! Description:
!
...
subroutine get_nb_energy_p1264(img_frc, img_crd, img_qterm, eed_cub, &  ! New2022
      ...
      if (ee_eval_cnt + full_eval_cnt .gt. 0) then
        ...
        if (cutoffs_equal) then
          call pairs_calc_efv(img_frc, img_crd, img_qterm, efs_tbl, &
                              ...
                              gbl_img_iac, gbl_cn1, gbl_cn2, & ! New2022
...
#define BUILD_PAIRS_P1264 ! New2022

#define BUILD_PAIRS_CALC_EFV
#define NEED_ENE
#define NEED_VIR
#include "pairs_calc_plj1264.i" ! New2022
#undef NEED_VIR
#undef NEED_ENE
...
end subroutine get_nb_energy_p1264 ! New2022
