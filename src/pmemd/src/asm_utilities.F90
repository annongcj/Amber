...
contains
	...
	subroutine read_string(file, string)
		...
		double precision, dimension(:,:), intent(out) :: string
	...
	subroutine matinv( M, Minv )
		...
		double precision, dimension(:), intent(out) :: Minv
		
		double precision, dimension(:,:), allocatable :: Mtmp
