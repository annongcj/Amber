...
! One pass to order 3:
      ...
      array(3, i) = one_half * w(i) * array(2, i)
      array(2, i) = one_half * ((w(i) + one) * array(1, i) + &
                    (two - w(i)) * array(2, i))
      array(1, i) = one_half * (one - w(i)) * array(1, i)
...
! One final pass to order 4:
      ...
      array(3, i) = one_third * ((w(i) + one) * array(2, i) + &
                    (three - w(i)) * array(3, i))
      array(2, i) = one_third * ((w(i) + two) * array(1, i) + &
                    (two - w(i)) * array(2, i))
      array(1, i) = one_third * (one - w(i)) * array(1, i)
    end do
