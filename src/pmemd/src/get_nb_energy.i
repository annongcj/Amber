      ...
      if (ee_eval_cnt + full_eval_cnt .gt. 0) then
        ...
        if (cutoffs_equal) then
          if(fswitch .le. 0) then
            ...
            call pairs_calc_efv_fs(img_frc, img_crd, img_qterm, efs_tbl, &
                              eed_cub, typ_ico, ipairs(ipairs_idx), &
                              gbl_img_iac, gbl_cn1, gbl_cn2, x_tran)
          end if
        else
          if(fswitch .le. 0) then
            ...
            call pairs_calc_efv_2cut_fs(img_frc, img_crd, img_qterm, efs_tbl, &
                                   eed_cub, typ_ico, ipairs(ipairs_idx), &
                                   gbl_img_iac, gbl_cn1, gbl_cn2, x_tran)
          end if
        end if
        ...
        if (need_virials) then
          ...
          if (cutoffs_equal) then
            if(fswitch .le. 0) then
              if(use_pme .eq. 0) then
                call pairs_calc_fv_vac(img_frc, img_crd, img_qterm, fs_tbl, &
                                   eed_cub, typ_ico, ipairs(ipairs_idx), &
                                   gbl_img_iac, gbl_cn1, gbl_cn2, x_tran)!modified _sp by Ashraf
              else
              ...
              call pairs_calc_fv_fs(img_frc, img_crd, img_qterm, fs_tbl, &
                               eed_cub, typ_ico, ipairs(ipairs_idx), &
                               gbl_img_iac, gbl_cn1, gbl_cn2, x_tran)
            end if
          else
            if(fswitch .le. 0) then
              ...
              call pairs_calc_fv_2cut_fs(img_frc, img_crd, img_qterm, fs_tbl, &
                                    eed_cub, typ_ico, ipairs(ipairs_idx), &
                                    gbl_img_iac, gbl_cn1, gbl_cn2, x_tran)
            end if
          end if
          ...
          if (cutoffs_equal) then
            if(fswitch .le. 0) then
              ...
              call pairs_calc_f_fs(img_frc, img_crd, img_qterm, fs_tbl, &
                              eed_cub, typ_ico, ipairs(ipairs_idx), &
                              gbl_img_iac, gbl_cn1, gbl_cn2, x_tran)
            end if
          else
            if(fswitch .le. 0) then
              ...
              call pairs_calc_f_2cut_fs(img_frc, img_crd, img_qterm, fs_tbl, &
                                   eed_cub, typ_ico, ipairs(ipairs_idx), &
                                   gbl_img_iac, gbl_cn1, gbl_cn2, x_tran)
            end if
          end if
